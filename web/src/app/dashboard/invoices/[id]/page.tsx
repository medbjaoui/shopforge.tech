    ...
    <div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Vendeur</p>
            ...
            {invoice.sellerPhone && <p className="text-sm text-gray-600">{invoice.sellerPhone}</p>}
          ...
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Acheteur</p>
            ...
            {invoice.buyerAddress && (
              <p className="text-sm text-gray-600 mt-1">{formatAddress(invoice.buyerAddress)}</p>
            )}
          </div>
        </div>
        ...
        <table className="w-full text-sm mb-6">
          <thead>
            <tr className="border-b-2 border-gray-200">
              ...
              <th className="text-right py-2.5 font-semibold text-gray-700">TVA {tvaPercent}%</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {invoice.items.map((item) => (
              <tr key={item.id}>
                ...
                <td className="py-2.5 text-right font-mono text-gray-700">{n3(item.unitPriceHT)}</td>
                <td className="py-2.5 text-right font-mono text-gray-500">{n3(item.totalTVA)}</td>
                <td className="py-2.5 text-right font-mono font-semibold text-gray-900">{n2(item.totalTTC)}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 text-xs text-gray-400 text-center print:mt-16">
          <p>Facture generee par ShopForge — shopforge.tech</p>
          <p className="mt-1">
